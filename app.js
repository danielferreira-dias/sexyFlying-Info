...
let gameHasBurningMode = false
let gameHasdoubleChance = false
            ...
            contentDisplay.featureContent.forEach((feature) => {
                ...
                switch (feature.type) {
                    ...
                    case "img_text":
                        ...
                        divImages.style.flexDirection = feature.contentDirection
                        ...
                        feature.url.forEach((url) => {
                            ...
                            if (url.length > 1) {
                                divImages.appendChild(contentDivImage);
                                contentDiv.appendChild(divImages)
                            } else {
